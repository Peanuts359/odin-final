...
function Friends({ fetchContacts, friendRequests, setFriendRequests }) {
  ...
  if (reqsIsLoading) {
    ...
    reqsToShow = <div className="no-reqs-msg">No friend requests</div>;
  }
